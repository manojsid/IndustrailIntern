  ...
  //Updating database
	...
	try
	{
		/*Getting the connection variable from session*/
			...
			//con = DriverManager.getConnection("jdbc:odbc:CourierSystem","root","");
		...
		int fid=0;
		rs1=stmt.executeQuery("select max(fid) from feedback");
		while(rs1.next())
		{
		fid=rs1.getInt(1);
		}
		...
		String Query = "Insert into Feedback(Fid,UserID,Feedback,DateSubmitted) values (\'"+fid+"\',\'"+From+"\',\'"+msg+"\',\'"+DateSubmitted+"\')";
