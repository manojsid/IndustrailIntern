...
<BODY CLASS="SC" >
<FORM NAME="LOGIN" ACTION="EditBranch1.jsp" onsubmit="return validate()" >
<HR>
...
<br><br>
	<TR class="row_title">
			<TD colspan=6 align=center><B><CENTER>Edit Branch Details </CENTER></B></TD>
	</TR>
	<TR>
	...
	<Td align=center>
		<TD class=row_odd><FONT COLOR="#9E9E9E">Enter your BranchID to edit branch details<br>
		</TD>
</TR>
