...
oCMenu.offlineUrl="file:///C:\Program Files\Apache Group\Tomcat 4.1\webapps\Matrimonial" //Value: "path_to_menu_file_offline/"
...
oCMenu.onlineUrl="http://localhost:8888/coolmenus/" //Value: "path_to_menu_file_online/"
...
oCMenu.barcolor="#9294A3"//"#E8E8E8" //The color of the background bar - Value: "color"
...
oCMenu.barheight="5.8%" //The height of the background bar. Set this to "menu" if you want it to be the same height as the menu. (this will change to match the border if you have one) - Value: px || "%" || "menu"
...
oCMenu.fromleft=15 //This is the left position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
oCMenu.fromtop=5 //This is the left position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
...
*/
//To set gap between menu items 
//oCMenu.menuplacement=new Array('1','150','301','451','601')
oCMenu.menuplacement=new Array('0%','12.5%','25%','37.5%','50%','62.5%','75%','87.5%','99%')
//oCMenu.menuplacement=new Array('10%','30%','50%','70%','90%')
...
oCMenu.level[0].bgcoloroff="###8FBDD1" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
oCMenu.level[0].bgcoloron="####92BCCF" //The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
oCMenu.level[0].textcolor="brown" //The default text color for each level[0] (top) items. You can override this on each item by spesifying the text color when making the item. - Value: "color"
...
oCMenu.level[0].bordercolor="#a8a8a8" //The border color for all level[0] (top) items. - Value: "color"
...
oCMenu.level[1].bgcoloroff="#c8c8c8"
oCMenu.level[1].bgcoloron="#336699"
...
*/
//ViewApparels
oCMenu.makeMenu('top','','<b>&nbsp;Home</b>',"",'ResultFrame',155,45,"Images/MatrimServices.jpg","Images/MatrimServices.jpg")

//ViewApparels
oCMenu.makeMenu('top1','','<b>&nbsp;Apparels</b>','ViewServices.jsp?Category=Apparels','ResultFrame',155,29,"Images/Apparals.jpg","Images/Apparals1.jpg")//,0,0,"","",'red','silver')
//Astrology
oCMenu.makeMenu('top2','','<b>&nbsp;Astrology</b>','ViewServices.jsp?Category=Astrology','ResultFrame',155,29,"Images/Astrology.jpg","Images/Astrology1.jpg")//,0,0,"","",'red','silver')
//Beauticians
oCMenu.makeMenu('top3','','<b>&nbsp;Beauticians</b>','ViewServices.jsp?Category=Beauticians','ResultFrame',155,29,"Images/Beauticians.jpg","Images/Beauticians1.jpg")//,0,0,"","",'red','silver')
//Caterers
oCMenu.makeMenu('top4','','<b>&nbsp;Caterers</b>','ViewServices.jsp?Category=Caterers','ResultFrame',155,29,"Images/Caterers.jpg","Images/Caterers1.jpg")//,0,0,"","",'red','silver')

//Invitations
oCMenu.makeMenu('top5','','<b>&nbsp;Invitations</b>','ViewServices.jsp?Category=Invitations','ResultFrame',155,29,"Images/Invitations.jpg","Images/Invitations1.jpg")//,0,0,"","",'red','silver')

//Mandaps
oCMenu.makeMenu('top6','','<b>&nbsp;Mandaps</b>','ViewServices.jsp?Category=Mandaps','ResultFrame',155,29,"Images/Mandaps.jpg","Images/Mandaps1.jpg")//,0,0,"","",'red','silver')

//Jewellers
oCMenu.makeMenu('top7','','<b>&nbsp;Jewellers</b>','ViewServices.jsp?Category=Jewellers','ResultFrame',155,29,"Images/Jewellers.jpg","Images/Jewellers1.jpg")//,0,0,"","",'red','silver')

//Florists
oCMenu.makeMenu('top8','','<b>&nbsp;Florists</b>','ViewServices.jsp?Category=Florists','ResultFrame',155,29,"Images/Florists.jpg","Images/Florists1.jpg")//,0,0,"","",'red','silver')

//Sastrigal
oCMenu.makeMenu('top9','','<b>&nbsp;Sastrigal</b>','ViewServices.jsp?Category=Sastrigal','ResultFrame',155,29,"Images/Sastrigal.jpg","Images/Sastrigal1.jpg")//,0,0,"","",'red','silver')

//Video
oCMenu.makeMenu('top10','','<b>&nbsp;Video</b>','ViewServices.jsp?Category=Video','ResultFrame',155,29,"Images/Video.jpg","Images/Video1.jpg")//,0,0,"","",'red','silver')

//Tours
oCMenu.makeMenu('top11','','<b>&nbsp;Travels</b>','ViewServices.jsp?Category=Travels','ResultFrame',155,29,"Images/Tours.jpg","Images/Tours1.jpg")//,0,0,"","",'red','silver')
